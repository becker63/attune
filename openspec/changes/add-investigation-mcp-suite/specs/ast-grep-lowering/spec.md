...
Run native ast-grep test, scan, and apply operations against an exact
investigation commit while retaining the rules, findings, and patches without
claiming semantic agreement with Joern, Maude, or fast-check.
