# hidden-research-evaluation Specification

## Purpose

Define versioned deterministic hidden evaluators that preserve quality components and cover the first motif family.
