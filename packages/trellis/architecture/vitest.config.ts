    ...
    alias: [
      {
        ...
        replacement: fileURLToPath(new URL("../../attune/discovery/src/index.ts", import.meta.url)),
      },
      {
      ...
      },
      {
        ...
        replacement: fileURLToPath(new URL("../../attune/joern-effect/node_modules/effect/dist/esm/index.js", import.meta.url)),
      },
    ],
  },
  test: {
