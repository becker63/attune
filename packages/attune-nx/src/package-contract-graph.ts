...
export const packageContractTargetSemantics = [
  {
    ...
    category: "sync",
    purpose: "Refresh authored project facts, cache-owned compatibility projections, and framework-owned source ownership records from Nx-owned metadata.",
    ...
    dependsOn: [],
    evidence: ["project facts refresh", "cache-owned generated artifacts", "updated framework-owned Source BOM projection"],
