...
export const packageContractTargetSemantics = [
  {
    ...
    category: "sync",
    purpose: "Regenerate the package contract, generated companion shells, central compile-only assertion aggregate, and framework-owned provenance records from Nx-owned metadata.",
    ...
    dependsOn: [],
    evidence: ["deterministic generated contract files", "updated framework-owned Source BOM projection"],
  ...
  },
  {
    ...
    reads: ["Source BOM projection", "src/**/*.ts", ".attune/cache/protocol/**/*"],
    writes: [],
    dependsOn: ["protocol-materialize"],
