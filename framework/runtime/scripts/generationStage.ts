...
switch (stage) {
  ...
  case "migrate": {
    ...
    console.log(JSON.stringify({
      stage,
      migration: "framework/runtime/sql/0001_framework_recipe_receipt_spine.sql",
      integration,
    }))
    break
  }
...
function applyMigrationAgainstLiveDb(): Record<string, unknown> {
  ...
  return {
    applied: true,
    path: "framework/runtime/sql/0001_framework_recipe_receipt_spine.sql",
  }
}
