...
const isFrameworkFile = (filePath: string): boolean => {
  ...
  return (
    ...
    normalized.startsWith("packages/trellis/") ||
    normalized.includes("/packages/trellis/")
  )
}
...
const isFrameworkRuntimeInternalImport = (importSource: string): boolean =>
  ...
  importSource.includes("packages/trellis/runtime/src/internal/") ||
  importSource.includes("packages/trellis/runtime/internal/")
...
const isFrameworkNxInternalImport = (importSource: string): boolean =>
  ...
  importSource.includes("packages/trellis/nx/src/internal/") ||
  importSource.includes("packages/trellis/nx/internal/")
