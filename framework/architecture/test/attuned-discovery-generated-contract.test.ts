...
} from "../src/generated/package-contracts/attuned-discovery/attune.contract.generated.js"
...
describe("attuned-discovery generated package contract", () => {
  it("materializes the core discovery runtime and auditable operation ids", () => {
  ...
  it("decodes the generated package contract and the domain/event codec boundary", () => {
  ...
  it("materializes package-level Reactivity and atom graph metadata", () => {
