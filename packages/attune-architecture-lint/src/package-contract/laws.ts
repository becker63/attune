...
export const LawFamilySchema = Schema.Literals(LawFamilies)
export type LawFamily = typeof LawFamilySchema.Type

export const CanonicalLawIds = [
  "schema.decode",
  "schema.encode",
  "schema.error-decode",
...
export const LawIdSchema = Schema.Literals(CanonicalLawIds)
export type LawId = typeof LawIdSchema.Type

export type SchemaLawId = "schema.decode" | "schema.encode"
export type ErrorSchemaLawId = "schema.error-decode"
export type ViewMovementLawId = "view.reactivity-key-moves" | "view.atom-moves" | "view.package-view-moves"
...
export type LawSeverity = "required" | "expected"
export type LawInferenceSource = "shared-kernel" | "operation-kind" | "operation-metadata" | "custom-extension"

export interface CanonicalLawDefinition<Id extends LawId = LawId> {
  readonly id: Id
...
export interface LawDescriptor<Id extends LawId = LawId> extends CanonicalLawDefinition<Id> {
  readonly source: LawInferenceSource
  readonly metadata?: Readonly<Record<string, unknown>>
}

export const LawDescriptorSchema = Schema.Struct({
  id: LawIdSchema,
  family: LawFamilySchema,
...
function law<Id extends LawId>(
  id: Id,
  family: LawFamily,
  severity: LawSeverity,
  operationKinds: readonly OperationKind[],
  description: string,
): CanonicalLawDefinition<Id> {
  return { id, family, severity, operationKinds, description }
}

export const CanonicalLawCatalog = [
  law("schema.decode", "schema-validation", "required", allOperationKinds, "Operation input payloads decode through the declared Effect Schema."),
  law("schema.encode", "schema-validation", "required", allOperationKinds, "Operation success payloads encode through the declared Effect Schema."),
  law("schema.error-decode", "schema-validation", "required", allOperationKinds, "Typed failure payloads decode through the declared Effect Schema."),
  law("determinism.same-input-same-output", "determinism-idempotence", "expected", [
    "codec",
    "query",
    "generator",
    "policy-rule",
  ...
  law("idempotence.same-observation-same-result", "determinism-idempotence", "expected", [
    "command",
    "resource-provider",
  ], "Repeated observation of the same desired state returns stable applied or observed evidence."),
  law("side-effect.readonly", "side-effect-boundary", "required", [
    "codec",
    "query",
    "policy-rule",
  ], "The operation does not perform durable writes or undeclared external effects."),
  law("side-effect.declared-boundary", "side-effect-boundary", "required", [
    "command",
    "projection",
    "event-facade",
    "resource-provider",
  ...
  law("side-effect.virtual-tree-only", "side-effect-boundary", "required", [
    "generator",
  ], "Generated output is constrained to the declared virtual tree and generated-file boundary."),
  law("side-effect.no-durable-atom-write", "side-effect-boundary", "required", [
    "atom-family",
  ], "Atoms remain read and reasoning surfaces and do not perform durable writes."),
  law("view.reactivity-key-moves", "view-movement", "expected", allOperationKinds, "Touched Reactivity keys move when the operation changes meaningful package facts."),
  law("view.atom-moves", "view-movement", "expected", allOperationKinds, "Declared atoms refresh or recompute when the operation changes meaningful package facts."),
  law("view.package-view-moves", "view-movement", "expected", allOperationKinds, "Package view atoms reflect declared state transitions."),
  law("resource.observe-before-apply", "observed-idempotence", "required", [
    "resource-provider",
  ], "Provider operations observe current state before applying changes."),
  law("resource.observed-idempotence", "observed-idempotence", "required", [
    "resource-provider",
  ], "Already-correct observed state returns observed or applied evidence without repeating work."),
  law("resource.current-destructive-proof", "destructive-approval", "required", [
    "resource-provider",
  ], "Destructive transitions consume current proof for the exact resource state being changed."),
  law("resource.destructive-approval", "destructive-approval", "required", [
    "resource-provider",
  ], "Destructive transitions consume an explicit current approval token or schema-backed gate."),
  law("resource.no-repeat-destructive", "destructive-approval", "required", [
    "resource-provider",
  ], "Destructive transitions are idempotent by observation rather than by repeating destructive work."),
  law("projection.event-decode", "projection-event-state", "required", [
    "projection",
  ], "Projection inputs decode as declared event records."),
  law("projection.state-decode", "projection-event-state", "required", [
    "projection",
  ], "Projection state snapshots decode and encode through the declared state schema."),
  law("projection.deterministic-replay", "projection-event-state", "expected", [
    "projection",
  ], "Equivalent event sequences replay to equivalent projected state."),
  law("event-facade.event-schema", "projection-event-state", "required", [
    "event-facade",
  ], "Event facade payloads decode and encode through the declared event schema."),
  law("event-facade.append-boundary", "projection-event-state", "required", [
    "event-facade",
  ], "Event facades append through the declared EventLog boundary only."),
  law("atom-family.base-refresh", "projection-event-state", "expected", [
    "atom-family",
  ], "Base atoms refresh from declared Reactivity keys."),
  law("atom-family.derived-composes", "projection-event-state", "expected", [
    "atom-family",
  ], "Derived atoms compose base or derived atoms instead of manually subscribing to hidden freshness channels."),
  law("generator.options-decode", "generator-provenance", "required", [
    "generator",
  ], "Generator option payloads decode through their declared Effect Schema."),
  law("generator.deterministic-output", "generator-provenance", "expected", [
    "generator",
  ], "Equivalent virtual tree and options produce deterministic generated output."),
  law("generator.provenance-recorded", "generator-provenance", "required", [
    "generator",
  ], "Generated files carry auditable generator provenance."),
  law("generator.no-untracked-output", "generator-provenance", "required", [
    "generator",
  ], "Generator output stays within the declared generated file set."),
  law("policy.finding-schema", "policy-findings", "required", [
    "policy-rule",
  ], "Policy findings decode and encode through the declared finding schema."),
  law("policy.deterministic-findings", "policy-findings", "expected", [
    "policy-rule",
  ], "Equivalent workspace facts produce deterministic policy findings."),
  law("policy.stable-diagnostic-ids", "policy-findings", "expected", [
    "policy-rule",
  ], "Policy diagnostics retain stable rule and finding identifiers."),
  law("joern.template-binding-schema", "joern-template-evidence", "required", [
    "joern-template",
  ], "Joern template bindings decode through the declared binding schema."),
  law("joern.evidence-schema", "joern-template-evidence", "required", [
    "joern-template",
  ], "Joern proof output normalizes into declared evidence packets."),
  law("joern.deterministic-template", "joern-template-evidence", "expected", [
    "joern-template",
  ], "Equivalent template bindings render deterministic Joern query/evidence requests."),
  law("joern.normalized-evidence", "joern-template-evidence", "required", [
    "joern-template",
  ], "Joern evidence is normalized before it is treated as proof."),
] as const satisfies readonly CanonicalLawDefinition[]
...
} as const satisfies Record<OperationKind, readonly LawId[]>
...
export interface OperationLawInput<Kind extends OperationKind = OperationKind> {
  ...
  readonly customLaws?: readonly LawDescriptor[]
}
...
export type InferredLawsFor<Operation extends { readonly kind: OperationKind }> =
  readonly LawDescriptor<AllowedLawIdForOperation<Operation>>[]
...
export const isLawAllowedForKind = <Kind extends OperationKind>(lawId: LawId, kind: Kind): lawId is AllowedLawIdForKind<Kind> =>
  allowedLawIdsForKind(kind).includes(lawId as AllowedLawIdForKind<Kind>)

export const inferLawIds = <Operation extends OperationLawInput>(operation: Operation): readonly AllowedLawIdForOperation<Operation>[] =>
  inferLaws(operation).map((descriptor) => descriptor.id) as readonly AllowedLawIdForOperation<Operation>[]

export const inferLaws = <Operation extends OperationLawInput>(operation: Operation): InferredLawsFor<Operation> => {
  const ids: LawId[] = ["schema.decode", "schema.encode"]
  ...
  const descriptors = uniqueLawIds(ids).map((id) => descriptorFor(id, sourceFor(operation, id), metadataFor(operation, id)))
  if (operation.customLaws) descriptors.push(...operation.customLaws)
  return descriptors as InferredLawsFor<Operation>
}

export const isLawAllowedForOperation = <Operation extends OperationLawInput>(
  lawId: LawId,
  operation: Operation,
): lawId is AllowedLawIdForOperation<Operation> => inferLawIds(operation).includes(lawId as AllowedLawIdForOperation<Operation>)
...
const canonicalLawById: ReadonlyMap<LawId, CanonicalLawDefinition> =
  new Map(CanonicalLawCatalog.map((definition) => [definition.id, definition]))

const descriptorFor = (
  id: LawId,
  source: LawInferenceSource,
  metadata?: Readonly<Record<string, unknown>>,
): LawDescriptor => {
  const definition = canonicalLawById.get(id)
  if (!definition) throw new Error(`Unknown canonical law id: ${id}`)
  if (metadata && Object.keys(metadata).length > 0) return { ...definition, source, metadata }
  return { ...definition, source }
}

const sourceFor = (operation: OperationLawInput, id: LawId): LawInferenceSource => {
...
const metadataFor = (operation: OperationLawInput, id: LawId): Readonly<Record<string, unknown>> | undefined => {
...
const isMetadataLaw = (operation: OperationLawInput, id: LawId): boolean =>
  viewLawIds(operation).includes(id as ViewMovementLawId) || resourceLawIds(operation).includes(id as ResourceMetadataLawId)

const hasErrorSchema = (operation: OperationLawInput): boolean => operation.schemas?.error !== undefined
...
const resourceLawIds = (operation: OperationLawInput): readonly ResourceMetadataLawId[] => {
  ...
  const ids: ResourceMetadataLawId[] = []
...
const uniqueLawIds = <Id extends LawId>(ids: readonly Id[]): readonly Id[] => [...new Set(ids)]
