# investigation-lifecycle-model Specification

## Purpose

Define a compact Effect-native investigation lifecycle with typed state capabilities, a closed tool registry, and durable terminalization.
