...
Expose the Effect MCP capability boundary as one deterministic, generator-ready
JSON Schema contract and checked-in strict Pydantic projections without creating
a second contract authority or a shared research ontology.
