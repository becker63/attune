# execution-receipts Specification

## Purpose

Define Effect-validated invocation receipts, append-only artifacts, explicit promotion, and read-only inspection without embedding a research runtime.
