...
export const discoverRouteView = (): ReadonlyArray<Html> => {
  const h = html<Message>()
...
export const workbenchRouteView = (model: Model): ReadonlyArray<Html> => {
  const h = html<Message>()
...
export const findingsRouteView = (): ReadonlyArray<Html> => {
  const h = html<Message>()
...
export const humanActionView = (items: ReadonlyArray<ActivityItem>): Html => {
  const h = html<Message>()
...
export const foldkitMdxBlocksView = (
