# investigation-workspaces Specification

## Purpose

Define exact commit-bound, capsule-isolated investigation workspaces with stable mounts, checkpoints, resume, and finalization.
