    ...
    return Visitor.merge(tracker, {
      ...
      CallExpression: (node) =>
        Effect.flatMap(Ref.get(depth), (d) => {
          ...
          const name = Option.getOrUndefined(AST.calleeName(node));
