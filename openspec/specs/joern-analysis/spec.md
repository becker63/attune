# joern-analysis Specification

## Purpose

Define investigation-scoped Joern CPG creation and query mechanics with complete bounded evidence and a controlled lifecycle.
