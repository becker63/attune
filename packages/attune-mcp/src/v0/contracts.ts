 ...
 * invocation identity, unavailable workspace state, or a descriptor contract
...
export const TOOL_CONTRACTS = {
  artifact_promote: {
    ...
    output: ArtifactPromoteResult,
  },
  ast_grep_run: { input: AstGrepRunInput, output: AstGrepRunResult },
  investigation_finalize: {
    input: InvestigationFinalizeInput,
    output: InvestigationFinalizeResult,
  },
  joern_query: { input: JoernQueryInput, output: JoernQueryResult },
  maude_run: { input: MaudeRunInput, output: MaudeRunResult },
  property_run: { input: PropertyRunInput, output: PropertyRunResult },
  repository_checkpoint: {
    input: RepositoryCheckpointInput,
    output: RepositoryCheckpointResult,
  },
  repository_materialize: {
    input: RepositoryMaterializeInput,
    output: RepositoryMaterializeResult,
  },
} as const;
