...
export const att50ImplementationSpec: ImplementationSpec = {
  ...
  propertyObligations: [
    {
      ...
      commands: ["NX_DAEMON=false TMPDIR=/tmp TEMP=/tmp TMP=/tmp pnpm exec nx run attune-pi-agent:proof"],
  ...
  validationCommands: [
    ...
    {
      id: "property",
      command: "NX_DAEMON=false TMPDIR=/tmp TEMP=/tmp TMP=/tmp pnpm exec nx run attune-pi-agent:proof",
      targetPackage: "attune-pi-agent",
      required: true,
    },
    {
