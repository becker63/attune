...
export const cocoIndexRepositorySessionRepair: RecipeRepair = {
  ...
  allowedFiles: ["packages/cocoindex-effect/**"],
  risk: "needs-review",
...
export const CocoIndexEffectRecipes = [
  defineRecipe({
    ...
    nxTarget: "cocoindex-effect:emit-mcp-schema",
    sourcePath: "packages/cocoindex-effect/src/recipes.ts",
    allowedFiles: [
      "packages/cocoindex-effect/scripts/generate-cocoindex-mcp-types.ts",
      "packages/cocoindex-effect/src/generated/**",
      "packages/cocoindex-effect/project.json",
    ],
    validationEvidence: ["cocoindex-effect:check-generated", "cocoindex-effect:test"],
  }),
  defineRecipe({
    ...
    nxTarget: "cocoindex-effect:scaffold-mcp-search-tool",
    sourcePath: "packages/cocoindex-effect/src/recipes.ts",
    allowedFiles: [
  ...
  defineRecipe({
    ...
    nxTarget: "cocoindex-effect:sync-mcp-tools",
    sourcePath: "packages/cocoindex-effect/src/recipes.ts",
    allowedFiles: [
      "packages/cocoindex-effect/src/cocoindex/tools/**",
  ...
  defineRecipe({
    ...
    nxTarget: "cocoindex-effect:check-generated",
    sourcePath: "packages/cocoindex-effect/src/recipes.ts",
    allowedFiles: [
      "packages/cocoindex-effect/src/generated/**",
      "packages/cocoindex-effect/src/cocoindex/tools/**",
  ...
  defineRecipe({
    ...
    nxTarget: "cocoindex-effect:test",
    sourcePath: "packages/cocoindex-effect/src/recipes.ts",
    allowedFiles: ["packages/cocoindex-effect/src/**"],
