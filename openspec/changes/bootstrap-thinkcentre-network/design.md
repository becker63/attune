...
- Use SOPS/sops-nix for Tailscale auth material and other bootstrap secrets, allowing encrypted secret files and public recipient metadata in git while keeping private keys and plaintext out of git.
...
3. Add SOPS age recipient metadata, encrypted bootstrap secret templates, and sops-nix host configuration for Tailscale auth keys.
