...
export const att50ImplementationSpec: ImplementationSpec = {
  ...
  testObligations: [
    {
      ...
      commands: ["NX_DAEMON=false TMPDIR=/tmp TEMP=/tmp TMP=/tmp corepack pnpm exec nx run attune-pi-agent:test"],
  ...
  propertyObligations: [
    {
      ...
      commands: ["NX_DAEMON=false TMPDIR=/tmp TEMP=/tmp TMP=/tmp corepack pnpm exec nx run attune-pi-agent:property"],
  ...
  mutationObligations: [
    {
      ...
      mutationCommand: "NX_DAEMON=false TMPDIR=/tmp TEMP=/tmp TMP=/tmp corepack pnpm exec nx run attune-pi-agent:mutation",
  ...
  snapshotObligations: [
    {
      ...
      updateCommand: "NX_DAEMON=false TMPDIR=/tmp TEMP=/tmp TMP=/tmp corepack pnpm exec nx run attune-pi-agent:test",
  ...
  validationCommands: [
    {
      id: "typecheck",
      command: "NX_DAEMON=false TMPDIR=/tmp TEMP=/tmp TMP=/tmp corepack pnpm exec nx run attune-pi-agent:typecheck",
      targetPackage: "attune-pi-agent",
      required: true,
    },
    {
      id: "test",
      command: "NX_DAEMON=false TMPDIR=/tmp TEMP=/tmp TMP=/tmp corepack pnpm exec nx run attune-pi-agent:test",
      targetPackage: "attune-pi-agent",
      required: true,
    },
    {
      id: "property",
      command: "NX_DAEMON=false TMPDIR=/tmp TEMP=/tmp TMP=/tmp corepack pnpm exec nx run attune-pi-agent:property",
      targetPackage: "attune-pi-agent",
      required: true,
    },
    {
      id: "mutation",
      command: "NX_DAEMON=false TMPDIR=/tmp TEMP=/tmp TMP=/tmp corepack pnpm exec nx run attune-pi-agent:mutation",
      targetPackage: "attune-pi-agent",
      required: false,
    },
  ],
