...
export const PlatformAlchemyK8sRecipes = [
  defineExternalSchemaRecipe({
    ...
    nxTarget: "platform-alchemy-k8s:test",
    sourcePath: "packages/platform-alchemy-k8s/src/recipes.ts",
    allowedFiles: ["packages/platform-alchemy-k8s/src/cluster/**"],
  ...
  defineExternalSchemaRecipe({
    ...
    nxTarget: "platform-alchemy-k8s:test",
    sourcePath: "packages/platform-alchemy-k8s/src/recipes.ts",
    allowedFiles: ["packages/platform-alchemy-k8s/src/resources/**"],
    validationEvidence: ["platform-alchemy-k8s:test"],
  }),
  defineExternalSchemaRecipe({
  ...
  defineExternalSchemaManagedRecipe({
    ...
    nxTarget: "platform-alchemy-k8s:test",
    sourcePath: "packages/platform-alchemy-k8s/src/recipes.ts",
    allowedFiles: ["packages/platform-alchemy-k8s/src/provider/**", "packages/platform-alchemy-k8s/src/resources/**"],
