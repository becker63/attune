      ...
      CallExpression: (node) => {
        ...
        for (const prop of opts.properties) {
          if (
            ...
            continue;
          const key = (prop as unknown as Record<string, unknown>)["key"] as Record<
            string,
            unknown
          > | null;
          const value = (prop as unknown as Record<string, unknown>)["value"] as Record<
            string,
            unknown
          > | null;
          ...
          if (
            ...
            if (
              ...
              const right = body["right"] as Record<string, unknown> | null;
